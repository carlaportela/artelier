  ...
  return (
    <EmailLayout>
      ...
      <Text style={{ fontFamily: fontBody, color: textDark, fontSize: "14px", margin: "0 0 8px 0" }}>
        {artisanName ?? "La artesana"} ha confirmado el envío de tu pedido. Pronto lo tendrás en casa.
      </Text>
      ...
      <Section style={{
        ...
        {trackingNumber && (
          <>
            ...
            <Text style={{ fontFamily: "monospace", color: textDark, fontSize: "13px", fontWeight: "600", margin: 0 }}>
              {trackingNumber}
            </Text>
          </>
        )}
